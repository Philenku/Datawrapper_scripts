...
columns = ["num_bottles","plastic_lids","bottle_caps","forks_knives_and_spoons","plastic_straws","food_wrappers",
"cigaretter_filters","vape_cartilages"]
...
trash_count = dw.create_chart(title = "Common trashes",
                chart_type= "d3-pies",
                data = count_df)
if len(sys.argv)==2:
